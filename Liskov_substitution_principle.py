...
# لو عندنا طائرين (بطريق - حمامه) و الاتنين هيستخدمو كلاس الطائر
# كده يبقي احنا استخدمنا المبدأ ده غلط لان ببساطه ال بطريق مش بيطير ! ايه هيخليه يستخدم كلاس الطائر دي !
# حل ال موضوع ده اننا نعمل اتنين كلاس (كلاس طائر - طائر يطير)
# كلاس ال طائر هيكون فيها وظيفه الاكل بس و كلاس الطائر يطير هيكون فيها وظيفه الطيران بس
# كلاس ال طائر يطير هيورث من كلاس الطائر الاساسيه و بالتالي هيكون ال وظيفتين متاحين فيها
# وساعتها ال بطريق هيستخدم كلاس الطائر 
# والحمامه هتستخدم كلاس الطائر يطير
# البطريق وظيفته هتكون الاكل بس اما الحمامه وظيفتها هتكون الاكل و الطياران